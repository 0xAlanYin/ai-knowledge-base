...
- 无当天文件时，读取最近修改的采集文件
- 支持的数据源目录：
  - `knowledge/raw/github/` — GitHub Trending 采集数据
  - `knowledge/raw/hackernews/` — Hacker News 采集数据
...
```json
{
  ...
  "raw_file": "knowledge/raw/github/github-trending-2026-04-22.json",
  "items": [
    {
      "name": "owner/repo",
  ...
  "trends": {
    "common_themes": [
      "Agent 框架持续爆发：今日 6 个项目与 Agent 编排相关"
    ],
    "new_concepts": [
      "MCP (Model Context Protocol) 首次出现在 2 个项目中"
    ],
